        ...
        document.querySelectorAll("form#edit-user").forEach(form => {
            form.addEventListener("submit", e => {
                ...
                const obj = {
                    ...
                    activities_balance: e.currentTarget.parentElement.querySelector("input#activities_balance").value,
                    referral_balance: e.currentTarget.parentElement.querySelector("input#referral_balance").value,
                    mining_balance: e.currentTarget.parentElement.querySelector("input#mining_balance").value,
                    vendor_balance: e.currentTarget.parentElement.querySelector("input#vendor_balance").value,
                    is_verify: e.currentTarget.parentElement.querySelector("select#verify").value,
                    is_vendor: e.currentTarget.parentElement.querySelector("select#is_vendor").value,
                };
