!(function (s) {
    ...
    function r(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e
            ? (s("html").removeAttr("dir"),
              ...
              s("#bootstrap-style").attr("href", "/user/css/bootstrap.min.css"),
              s("#app-style").attr("href", "/user/css/app.min.css"),
              s("body").attr("data-sidebar",""),
              setCookie("is_visited", "light-mode-switch", "7"),
            ...
            ? (s("html").removeAttr("dir"),
              ...
              s("#rtl-mode-switch").prop("checked", !1),
              s("#dark-rtl-mode-switch").prop("checked", !1),
              s("#bootstrap-style").attr("href", "/user/css/bootstrap-dark.min.css"),
              s("#app-style").attr("href", "/user/css/app-dark.min.css"),
              s("body").attr("data-sidebar","dark"),
              setCookie("is_visited", "dark-mode-switch", "7"),
    ...
    function l() {
        document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement || (console.log(""), s("body").removeClass("fullscreen-enable"));
    }
